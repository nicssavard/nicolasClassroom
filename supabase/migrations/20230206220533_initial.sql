...
alter table "public"."Class" add constraint "Class_subject_id_fkey" FOREIGN KEY (subject_id) REFERENCES "Subject"(id) ON UPDATE CASCADE ON DELETE RESTRICT not valid;

alter table "public"."Class" validate constraint "Class_subject_id_fkey";

alter table "public"."Flashcard" add constraint "Flashcard_class_id_fkey" FOREIGN KEY (class_id) REFERENCES "Class"(id) ON UPDATE CASCADE ON DELETE RESTRICT not valid;

alter table "public"."Flashcard" validate constraint "Flashcard_class_id_fkey";

alter table "public"."Flashcard" add constraint "Flashcard_subject_id_fkey" FOREIGN KEY (subject_id) REFERENCES "Subject"(id) ON UPDATE CASCADE ON DELETE RESTRICT not valid;

alter table "public"."Flashcard" validate constraint "Flashcard_subject_id_fkey";
...
alter table "public"."User" add constraint "User_group_id_fkey" FOREIGN KEY (group_id) REFERENCES "Group"(id) ON UPDATE CASCADE ON DELETE RESTRICT not valid;

alter table "public"."User" validate constraint "User_group_id_fkey";
